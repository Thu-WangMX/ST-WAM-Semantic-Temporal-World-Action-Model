...
def main(cfg: DictConfig):
    ...
    semantic_history_cfg = cfg.model.get("semantic_history_config")
    if semantic_history_cfg is not None:
        _append_override(
            overrides,
            "vlm_model_name_or_path",
            semantic_history_cfg.get("vlm_model_name_or_path"),
        )
        _append_override(
            overrides,
            "allow_vlm_path_relocation",
            semantic_history_cfg.get("allow_vlm_path_relocation", False),
        )
