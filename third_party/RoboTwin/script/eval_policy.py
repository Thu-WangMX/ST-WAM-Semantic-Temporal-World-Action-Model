...
def main(usr_args):
    ...
    eval_video_log = parse_bool(usr_args.get("eval_video_log", False))
    ...
    # Evaluation runs headless on remote servers; camera RGB rendering still works
    # with render_freq=0, but SAPIEN will not try to create an interactive Viewer.
    args["render_freq"] = int(usr_args.get("render_freq", 0))
